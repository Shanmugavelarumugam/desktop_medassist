...
mixin _$InventoryState {
 ...
 List<Medicine> get medicines; List<MedicineCategory> get categories; List<Manufacturer> get manufacturers; bool get isLoading; String? get errorMessage; String get search; String get selectedCategory; String get selectedStatus;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(medicines),const DeepCollectionEquality().hash(categories),const DeepCollectionEquality().hash(manufacturers),isLoading,errorMessage,search,selectedCategory,selectedStatus);

@override
String toString() {
  return 'InventoryState(medicines: $medicines, categories: $categories, manufacturers: $manufacturers, isLoading: $isLoading, errorMessage: $errorMessage, search: $search, selectedCategory: $selectedCategory, selectedStatus: $selectedStatus)';
}
...
@useResult
$Res call({
 List<Medicine> medicines, List<MedicineCategory> categories, List<Manufacturer> manufacturers, bool isLoading, String? errorMessage, String search, String selectedCategory, String selectedStatus
});
...
/// Create a copy of InventoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? medicines = null,Object? categories = null,Object? manufacturers = null,Object? isLoading = null,Object? errorMessage = freezed,Object? search = null,Object? selectedCategory = null,Object? selectedStatus = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Medicine> medicines,  List<MedicineCategory> categories,  List<Manufacturer> manufacturers,  bool isLoading,  String? errorMessage,  String search,  String selectedCategory,  String selectedStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InventoryState() when $default != null:
return $default(_that.medicines,_that.categories,_that.manufacturers,_that.isLoading,_that.errorMessage,_that.search,_that.selectedCategory,_that.selectedStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Medicine> medicines,  List<MedicineCategory> categories,  List<Manufacturer> manufacturers,  bool isLoading,  String? errorMessage,  String search,  String selectedCategory,  String selectedStatus)  $default,) {final _that = this;
switch (_that) {
case _InventoryState():
return $default(_that.medicines,_that.categories,_that.manufacturers,_that.isLoading,_that.errorMessage,_that.search,_that.selectedCategory,_that.selectedStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Medicine> medicines,  List<MedicineCategory> categories,  List<Manufacturer> manufacturers,  bool isLoading,  String? errorMessage,  String search,  String selectedCategory,  String selectedStatus)?  $default,) {final _that = this;
switch (_that) {
case _InventoryState() when $default != null:
return $default(_that.medicines,_that.categories,_that.manufacturers,_that.isLoading,_that.errorMessage,_that.search,_that.selectedCategory,_that.selectedStatus);case _:
  return null;
...
class _InventoryState implements InventoryState {
  const _InventoryState({final  List<Medicine> medicines = const [], final  List<MedicineCategory> categories = const [], final  List<Manufacturer> manufacturers = const [], this.isLoading = false, this.errorMessage, this.search = '', this.selectedCategory = 'All Categories', this.selectedStatus = 'All Status'}): _medicines = medicines,_categories = categories,_manufacturers = manufacturers;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_medicines),const DeepCollectionEquality().hash(_categories),const DeepCollectionEquality().hash(_manufacturers),isLoading,errorMessage,search,selectedCategory,selectedStatus);
...
/// Create a copy of InventoryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? medicines = null,Object? categories = null,Object? manufacturers = null,Object? isLoading = null,Object? errorMessage = freezed,Object? search = null,Object? selectedCategory = null,Object? selectedStatus = null,}) {
